...
const ProductDetailPage = ({ id }) => {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-md bg-[#FFF9E5] font-sans text-[#211F26] pb-20">
      {/* Back Button */}
      ...
      <div className="bg-[#FFF9E5] p-4">
        ...
        <p className="mt-2 text-xs font-bold uppercase tracking-wide text-[#6F6B76]">Packaging — Make it yours</p>
        ...
        <div className="space-y-3">
          {drinks.map((drink) => (
            <div key={drink.id} className="flex items-center gap-3 rounded-xl border border-[#E9E5EE] p-2">
              <img src={drink.image || '/placeholder.jpg'} alt={drink.name} className="h-12 w-12 rounded-lg object-cover" />
      ...
      {/* FIXED STICKY BUTTON (Sits Above the Purple Nav) */}
      <div className="sticky bottom-16 z-30 bg-[#FFF9E5] p-4 pb-6 shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
