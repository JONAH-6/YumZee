  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#3E2679] px-6 text-center">
      ...
      <div className="relative z-10 flex w-full max-w-xs flex-col items-center">
        {/* Video hero */}
        <div className="anim-pop-in relative w-full">
          <video
            ...
            muted
            playsInline
            className="anim-bounce-soft mb-1 h-60 w-full object-contain drop-shadow-2xl"
          />
          {/* Delivery time badge */}
          <div className="anim-wiggle absolute -right-2 top-4 flex items-center gap-2 rounded-2xl bg-white px-3 py-2 text-left shadow-xl">
          ...
          {/* Hot & fresh badge */}
          <div
            className="anim-wiggle absolute -left-2 bottom-6 flex items-center gap-2 rounded-2xl bg-[#FFC107] px-3 py-2 text-left shadow-xl"
        ...
        {/* Brand */}
        <h1
          className="anim-fade-up mt-2 text-6xl font-black tracking-tight drop-shadow-lg"
        ...
        {/* Tagline */}
        <p
          className="anim-fade-up mt-2 text-sm font-light tracking-wide text-white/80"
        ...
        {/* Snack ticker */}
        <div
          className="anim-fade-up mt-6 w-full overflow-hidden rounded-full border border-white/15 bg-white/10 py-2 backdrop-blur"
        ...
        {/* Continue with Google Button - ALIGNED with ticker */}
        <button
          onClick={handleGetStarted}
          className="anim-fade-up mt-5 flex w-full items-center justify-center gap-3 rounded-full bg-white py-4 text-base font-bold text-gray-800 transition hover:bg-gray-100 active:scale-95"
